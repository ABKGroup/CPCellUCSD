...
Layer "M0" { 
  ...
  minSpacing = 0.010
  minArea = 0.000
  endOfLine1NeighborEndToEndThreshold = 0.006
  endOfLine1NeighborEndToEndThreshold2 = 0.006
  endOfLine1NeighborEndToEndParallelWidth = 0.000 
  endOfLine1NeighborEndToEndMinSpacing = 0.006
}
...
Layer "M1" { 
  ...
  minSpacing = 0.012
  minArea = 0.000
  endOfLine1NeighborEndToEndThreshold = 0.027
  endOfLine1NeighborEndToEndThreshold2 = 0.027
  endOfLine1NeighborEndToEndParallelWidth = 0.000 
  endOfLine1NeighborEndToEndMinSpacing = 0.027
}
...
DesignRule {
 ...
 cut1NameTbl = (Vx)
 cut2NameTbl = (Vx)
 sameNetCenterMinSpacingTbl = (0.038)
 diffNetCenterMinSpacingTbl = (0.038)
}
...
DesignRule {
 ...
 cut1NameTbl = (Vx)
 cut2NameTbl = (Vx)
 sameNetCenterMinSpacingTbl = (0.016)
 diffNetCenterMinSpacingTbl = (0.016)
}
