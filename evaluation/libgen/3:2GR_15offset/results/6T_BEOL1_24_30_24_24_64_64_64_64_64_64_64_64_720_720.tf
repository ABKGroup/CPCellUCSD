...
Layer "M0" { 
  ...
  minSpacing = 0.010
  minArea = 0.000
  endOfLine1NeighborEndToEndThreshold = 0.009
  endOfLine1NeighborEndToEndThreshold2 = 0.009
  endOfLine1NeighborEndToEndParallelWidth = 0.000 
  endOfLine1NeighborEndToEndMinSpacing = 0.009
}
...
DesignRule {
 ...
 cut1NameTbl = (Vx)
 cut2NameTbl = (Vx)
 sameNetCenterMinSpacingTbl = (0.019)
 diffNetCenterMinSpacingTbl = (0.019)
}
