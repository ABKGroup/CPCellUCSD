...
# DESIGN : Design name
export BEOL = BEOL1_24_22.5_24_24_64_64_64_64_64_64_64_64_720_720
export PDN = MIDDLE
export TOOL = ICC2
export UTIL = 85
export DESIGN = AES
...
# 41 cell masters
export CELLS = DFFHQN_X1 INV_X1 INV_X2 INV_X4 INV_X8 AND2_X1 AND3_X1 OR2_X1 OR3_X1 OR2_X2 \
OR3_X2 AND3_X2 NAND2_X1 NAND3_X1 NAND4_X1 NOR2_X1 NOR3_X1 NOR4_X1 XOR2_X1 MUX2_X1 \
BUF_X1 BUF_X2 BUF_X4 BUF_X8 NAND2_X2 NAND4_X2 NOR2_X2 NOR3_X2 NOR4_X2 AOI21_X1 OAI21_X1 \
AOI22_X1 OAI22_X1 AOI21_X2 OAI21_X2 AOI22_X2 OAI22_X2 LHQ_X1 AND2_X2 NAND3_X2 

# Library name (Do not mofify)
export LIB_NAME = $(CHSTR)T_$(FIN)F_$(CPP)CPP_$(M0P)M0P_22p5M1P_OF0_$(M2P)M2P_$(MPO)MPO_$(DR)_$(PGPIN)
