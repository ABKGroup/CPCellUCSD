...
Layer "M0" { 
  ...
  minSpacing = 0.010
  minArea = 0.000
  endOfLine1NeighborEndToEndThreshold = 0.021
  endOfLine1NeighborEndToEndThreshold2 = 0.021
  endOfLine1NeighborEndToEndParallelWidth = 0.000 
  endOfLine1NeighborEndToEndMinSpacing = 0.021
}
...
Layer "M1" { 
  ...
  minSpacing = 0.022
  minArea = 0.001
  endOfLine1NeighborEndToEndThreshold = 0.044
  endOfLine1NeighborEndToEndThreshold2 = 0.044
  endOfLine1NeighborEndToEndParallelWidth = 0.000 
  endOfLine1NeighborEndToEndMinSpacing = 0.044
}
...
DesignRule {
 ...
 cut1NameTbl = (Vx)
 cut2NameTbl = (Vx)
 sameNetCenterMinSpacingTbl = (0.064)
 diffNetCenterMinSpacingTbl = (0.064)
}
...
ContactCode "V0_HV" {
  ...
  lowerLayer = "M0"
  upperLayer = "M1"
  upperLayerEncWidth = 0.003999999999999999
...
ContactCode "V1_VH" {
  ...
  lowerLayerEncWidth = 0.003999999999999999
